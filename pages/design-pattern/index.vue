<template>
  <v-container>
    <section class="d-flex flex-column align-center">
      ...
      <p class="text-center w-420">
        <span class="font-weight-bold">الگو‌های طراحی</span>
        راه حل های معمولی برای مشکلات رایج در طراحی نرم افزار است. هر الگو مانند
        یک طرح اولیه است که می‌توانید برای حل مشکل خود در یک مورد خاص استفاده
        کنید.
      </p>
    </section>
          ...
          <section class="absolute absolute-left-top">
            <div class="panel pa-2 mb-2">
              ...
              <p class="text-left">
                ...
                هستند. علاوه بر این، آنها را می توان بر اساس قصد آنها به سه گروه
                دسته بندی کرد.
              </p>
            </div>
            <div class="panel pa-2">
